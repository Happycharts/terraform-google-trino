...
module "network" {
  ...
  subnets = [
    {
      subnet_name   = "${var.network_name}-${var.environment}-${var.region}-a"
      subnet_ip     = "10.0.1.0/24"
      subnet_region = var.region
    },
    {
      subnet_name   = "${var.network_name}-${var.environment}-${var.region}-b"
      subnet_ip     = "10.0.2.0/24"
      subnet_region = var.region
    },
    {
      subnet_name   = "${var.network_name}-${var.environment}-${var.region}-c"
